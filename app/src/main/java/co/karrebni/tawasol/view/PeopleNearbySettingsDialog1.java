package co.karrebni.tawasol.view;
...
public class PeopleNearbySettingsDialog1 extends DialogFragment implements Constants {
    ...
    PeopleNearbySettingsDialog1.AlertPositiveListener alertPositiveListener;
    ...
    public void onAttach(android.app.Activity activity) {
        ...
        try {
            ...
            alertPositiveListener = (PeopleNearbySettingsDialog1.AlertPositiveListener) activity;
    ...
    DialogInterface.OnClickListener positiveListener = new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            alertPositiveListener.onChangeDistance1(position);
        }
    };
