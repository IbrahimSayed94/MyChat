package co.karrebni.tawasol.adapter;
...
public class DialogListAdapter extends BaseAdapter implements Constants {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (chat.getLastMessage().length() != 0) {
			...
			viewHolder.chatLastMessage.setText(chat.getLastMessage());
			viewHolder.chatLastMessage.setVisibility(View.INVISIBLE);

//            Toast.makeText(convertView.getContext(),""+chat.getLastMessage(),Toast.LENGTH_SHORT).show();
